CREATE DATABASE  IF NOT EXISTS `peluqueria_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `peluqueria_db`;
...
--
-- Dumping data for table `ausencias_empleados`
--

LOCK TABLES `ausencias_empleados` WRITE;
/*!40000 ALTER TABLE `ausencias_empleados` DISABLE KEYS */;
/*!40000 ALTER TABLE `ausencias_empleados` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `calendarios_google`
--

LOCK TABLES `calendarios_google` WRITE;
/*!40000 ALTER TABLE `calendarios_google` DISABLE KEYS */;
/*!40000 ALTER TABLE `calendarios_google` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `carrusel_multimedia`
--

LOCK TABLES `carrusel_multimedia` WRITE;
/*!40000 ALTER TABLE `carrusel_multimedia` DISABLE KEYS */;
/*!40000 ALTER TABLE `carrusel_multimedia` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `carruseles` VALUES (1,'Carrusel Principal','Carrusel principal de la página de inicio',5000,'fade',1,'inicio',1,'2025-05-10 17:19:51','2025-05-10 17:19:51'),(2,'Promociones','Carrusel de promociones actuales',4000,'slide',1,'inicio',2,'2025-05-10 17:19:51','2025-05-10 17:19:51'),(3,'Testimonios','Carrusel con fotos y comentarios de clientes',6000,'fade',1,'inicio',3,'2025-05-10 17:19:51','2025-05-10 17:19:51');
...
--
-- Dumping data for table `categorias_galeria`
--

LOCK TABLES `categorias_galeria` WRITE;
/*!40000 ALTER TABLE `categorias_galeria` DISABLE KEYS */;
/*!40000 ALTER TABLE `categorias_galeria` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `categorias_servicios` VALUES (1,'pelo','rapido','2025-05-10 19:30:00','2025-05-10 19:30:00');
...
--
-- Dumping data for table `configuraciones_google`
--

LOCK TABLES `configuraciones_google` WRITE;
/*!40000 ALTER TABLE `configuraciones_google` DISABLE KEYS */;
INSERT INTO `configuraciones_google` VALUES (1,'google_calendar_client_id','','ID de cliente para OAuth de Google Calendar',1,'2025-05-10 17:22:50','2025-05-10 17:22:50'),(2,'google_calendar_client_secret','','Secret de cliente para OAuth de Google Calendar',1,'2025-05-10 17:22:50','2025-05-10 17:22:50'),(3,'google_calendar_redirect_uri','','URI de redirección para OAuth de Google Calendar',1,'2025-05-10 17:22:50','2025-05-10 17:22:50'),(4,'gmail_client_id','','ID de cliente para OAuth de Gmail API',1,'2025-05-10 17:22:50','2025-05-10 17:22:50'),(5,'gmail_client_secret','','Secret de cliente para OAuth de Gmail API',1,'2025-05-10 17:22:50','2025-05-10 17:22:50'),(6,'gmail_redirect_uri','','URI de redirección para OAuth de Gmail API',1,'2025-05-10 17:22:50','2025-05-10 17:22:50'),(7,'remitente_nombre','Peluquería','Nombre del remitente para los correos',1,'2025-05-10 17:22:50','2025-05-10 17:22:50'),(8,'remitente_email','citas@tupeluqueria.com','Email del remitente para los correos',1,'2025-05-10 17:22:50','2025-05-10 17:22:50');
/*!40000 ALTER TABLE `configuraciones_google` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `empleado_especialidad`
--

LOCK TABLES `empleado_especialidad` WRITE;
/*!40000 ALTER TABLE `empleado_especialidad` DISABLE KEYS */;
/*!40000 ALTER TABLE `empleado_especialidad` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `empleado_servicio`
--

LOCK TABLES `empleado_servicio` WRITE;
...
INSERT INTO `estados_citas` VALUES (1,'Pendiente','Cita agendada pero aún no confirmada','#FFC107','2025-05-10 17:17:04','2025-05-10 17:17:04'),(2,'Confirmada','Cita confirmada por el cliente','#4CAF50','2025-05-10 17:17:04','2025-05-10 17:17:04'),(3,'En proceso','Cliente está siendo atendido','#2196F3','2025-05-10 17:17:04','2025-05-10 17:17:04'),(4,'Completada','Servicio finalizado correctamente','#8BC34A','2025-05-10 17:17:04','2025-05-10 17:17:04'),(5,'Cancelada','Cita cancelada','#F44336','2025-05-10 17:17:04','2025-05-10 17:17:04'),(6,'No asistió','Cliente no se presentó a la cita','#9E9E9E','2025-05-10 17:17:04','2025-05-10 17:17:04');
...
INSERT INTO `estados_pago` VALUES (1,'Pendiente','Pago aún no procesado','2025-05-10 17:17:04','2025-05-10 17:17:04'),(2,'Procesando','Pago en proceso','2025-05-10 17:17:04','2025-05-10 17:17:04'),(3,'Completado','Pago completado correctamente','2025-05-10 17:17:04','2025-05-10 17:17:04'),(4,'Fallido','Error en el procesamiento del pago','2025-05-10 17:17:04','2025-05-10 17:17:04'),(5,'Reembolsado','Pago devuelto al cliente','2025-05-10 17:17:04','2025-05-10 17:17:04'),(6,'Parcial','Pago parcial realizado','2025-05-10 17:17:04','2025-05-10 17:17:04');
...
--
-- Dumping data for table `eventos_google_calendar`
--

LOCK TABLES `eventos_google_calendar` WRITE;
/*!40000 ALTER TABLE `eventos_google_calendar` DISABLE KEYS */;
/*!40000 ALTER TABLE `eventos_google_calendar` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `fichas_clientes`
--

LOCK TABLES `fichas_clientes` WRITE;
/*!40000 ALTER TABLE `fichas_clientes` DISABLE KEYS */;
/*!40000 ALTER TABLE `fichas_clientes` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `galeria_categoria` WRITE;
...
LOCK TABLES `galeria_multimedia` WRITE;
/*!40000 ALTER TABLE `galeria_multimedia` DISABLE KEYS */;
/*!40000 ALTER TABLE `galeria_multimedia` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `historial_servicios_cliente`
--

LOCK TABLES `historial_servicios_cliente` WRITE;
/*!40000 ALTER TABLE `historial_servicios_cliente` DISABLE KEYS */;
/*!40000 ALTER TABLE `historial_servicios_cliente` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `metodos_pago` VALUES (1,'Efectivo','Pago en efectivo',1,'2025-05-10 17:17:04','2025-05-10 17:17:04'),(2,'Tarjeta de crédito','Pago con tarjeta de crédito',1,'2025-05-10 17:17:04','2025-05-10 17:17:04'),(3,'Tarjeta de débito','Pago con tarjeta de débito',1,'2025-05-10 17:17:04','2025-05-10 17:17:04'),(4,'Transferencia bancaria','Pago mediante transferencia',1,'2025-05-10 17:17:04','2025-05-10 17:17:04'),(5,'PayPal','Pago mediante PayPal',1,'2025-05-10 17:17:04','2025-05-10 17:17:04'),(6,'Monedero electrónico','Pago con saldo del monedero',1,'2025-05-10 17:17:04','2025-05-10 17:17:04');
...
--
-- Dumping data for table `notificaciones_push`
--

LOCK TABLES `notificaciones_push` WRITE;
/*!40000 ALTER TABLE `notificaciones_push` DISABLE KEYS */;
/*!40000 ALTER TABLE `notificaciones_push` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `notificaciones_push_enviadas`
--

LOCK TABLES `notificaciones_push_enviadas` WRITE;
/*!40000 ALTER TABLE `notificaciones_push_enviadas` DISABLE KEYS */;
/*!40000 ALTER TABLE `notificaciones_push_enviadas` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `plantillas_correo` VALUES (1,'Confirmación de Cita','Confirmación de tu cita en Peluquería','<html><body><h1>¡Cita Confirmada!</h1><p>Hola {{NOMBRE_CLIENTE}},</p><p>Tu cita ha sido confirmada para el día {{FECHA_CITA}} a las {{HORA_CITA}} con {{NOMBRE_ESTILISTA}}.</p><p>Servicios reservados: {{SERVICIOS}}</p><p>Para cancelar o reprogramar, llámanos al {{TELEFONO_SALON}} o responde a este correo.</p><p>¡Esperamos verte pronto!</p><p>Equipo de la Peluquería</p></body></html>','¡Cita Confirmada!\n\nHola {{NOMBRE_CLIENTE}},\n\nTu cita ha sido confirmada para el día {{FECHA_CITA}} a las {{HORA_CITA}} con {{NOMBRE_ESTILISTA}}.\n\nServicios reservados: {{SERVICIOS}}\n\nPara cancelar o reprogramar, llámanos al {{TELEFONO_SALON}} o responde a este correo.\n\n¡Esperamos verte pronto!\n\nEquipo de la Peluquería','confirmacion_cita',1,'NOMBRE_CLIENTE,FECHA_CITA,HORA_CITA,NOMBRE_ESTILISTA,SERVICIOS,TELEFONO_SALON','2025-05-10 17:22:50','2025-05-10 17:22:50'),(2,'Recordatorio de Cita','Recordatorio: Tu cita en Peluquería mañana','<html><body><h1>Recordatorio de Cita</h1><p>Hola {{NOMBRE_CLIENTE}},</p><p>Te recordamos que tienes una cita programada para mañana {{FECHA_CITA}} a las {{HORA_CITA}} con {{NOMBRE_ESTILISTA}}.</p><p>Servicios reservados: {{SERVICIOS}}</p><p>¡Esperamos verte pronto!</p><p>Equipo de la Peluquería</p></body></html>','Recordatorio de Cita\n\nHola {{NOMBRE_CLIENTE}},\n\nTe recordamos que tienes una cita programada para mañana {{FECHA_CITA}} a las {{HORA_CITA}} con {{NOMBRE_ESTILISTA}}.\n\nServicios reservados: {{SERVICIOS}}\n\n¡Esperamos verte pronto!\n\nEquipo de la Peluquería','recordatorio',1,'NOMBRE_CLIENTE,FECHA_CITA,HORA_CITA,NOMBRE_ESTILISTA,SERVICIOS','2025-05-10 17:22:50','2025-05-10 17:22:50'),(3,'Cancelación de Cita','Cancelación de cita en Peluquería','<html><body><h1>Cita Cancelada</h1><p>Hola {{NOMBRE_CLIENTE}},</p><p>Confirmamos que tu cita programada para el {{FECHA_CITA}} a las {{HORA_CITA}} ha sido cancelada.</p><p>Si deseas reprogramar, puedes hacerlo a través de nuestra página web o llamándonos al {{TELEFONO_SALON}}.</p><p>Equipo de la Peluquería</p></body></html>','Cita Cancelada\n\nHola {{NOMBRE_CLIENTE}},\n\nConfirmamos que tu cita programada para el {{FECHA_CITA}} a las {{HORA_CITA}} ha sido cancelada.\n\nSi deseas reprogramar, puedes hacerlo a través de nuestra página web o llamándonos al {{TELEFONO_SALON}}.\n\nEquipo de la Peluquería','cancelacion',1,'NOMBRE_CLIENTE,FECHA_CITA,HORA_CITA,TELEFONO_SALON','2025-05-10 17:22:50','2025-05-10 17:22:50'),(4,'Bienvenida','Bienvenido/a a Peluquería','<html><body><h1>¡Bienvenido/a a nuestra familia!</h1><p>Hola {{NOMBRE_CLIENTE}},</p><p>Queremos darte la bienvenida a Peluquería. Estamos emocionados de tenerte como cliente.</p><p>Nuestro equipo está dedicado a brindarte la mejor experiencia en cuidado personal.</p><p>Como regalo de bienvenida, te ofrecemos un {{PROMOCION_BIENVENIDA}} en tu primera visita.</p><p>¡Esperamos verte pronto!</p><p>Equipo de la Peluquería</p></body></html>','¡Bienvenido/a a nuestra familia!\n\nHola {{NOMBRE_CLIENTE}},\n\nQueremos darte la bienvenida a Peluquería. Estamos emocionados de tenerte como cliente.\n\nNuestro equipo está dedicado a brindarte la mejor experiencia en cuidado personal.\n\nComo regalo de bienvenida, te ofrecemos un {{PROMOCION_BIENVENIDA}} en tu primera visita.\n\n¡Esperamos verte pronto!\n\nEquipo de la Peluquería','bienvenida',1,'NOMBRE_CLIENTE,PROMOCION_BIENVENIDA','2025-05-10 17:22:50','2025-05-10 17:22:50'),(5,'Promoción','¡Promoción especial para ti!','<html><body><h1>¡Oferta Especial!</h1><p>Hola {{NOMBRE_CLIENTE}},</p><p>Queremos ofrecerte una promoción especial: {{DESCRIPCION_PROMOCION}}</p><p>Esta oferta es válida hasta el {{FECHA_LIMITE_PROMOCION}}.</p><p>Para aprovecharla, menciona el código {{CODIGO_PROMOCION}} al hacer tu reserva.</p><p>¡Te esperamos!</p><p>Equipo de la Peluquería</p></body></html>','¡Oferta Especial!\n\nHola {{NOMBRE_CLIENTE}},\n\nQueremos ofrecerte una promoción especial: {{DESCRIPCION_PROMOCION}}\n\nEsta oferta es válida hasta el {{FECHA_LIMITE_PROMOCION}}.\n\nPara aprovecharla, menciona el código {{CODIGO_PROMOCION}} al hacer tu reserva.\n\n¡Te esperamos!\n\nEquipo de la Peluquería','promocion',1,'NOMBRE_CLIENTE,DESCRIPCION_PROMOCION,FECHA_LIMITE_PROMOCION,CODIGO_PROMOCION','2025-05-10 17:22:50','2025-05-10 17:22:50');
...
INSERT INTO `roles` VALUES (1,'administrador','Control total del sistema','2025-05-10 17:17:04','2025-05-10 17:17:04'),(2,'empleado','Acceso a agenda y servicios','2025-05-10 17:17:04','2025-05-10 17:17:04'),(3,'cliente','Acceso a su perfil y citas','2025-05-10 17:17:04','2025-05-10 17:17:04');
...
INSERT INTO `servicios` VALUES (1,1,'black','gfd',20,3.00,NULL,1,'2025-05-10 19:30:00','2025-05-10 19:30:00');
...
--
-- Dumping data for table `tipos_multimedia`
--

LOCK TABLES `tipos_multimedia` WRITE;
/*!40000 ALTER TABLE `tipos_multimedia` DISABLE KEYS */;
INSERT INTO `tipos_multimedia` VALUES (1,'Carrusel','Imágenes y videos para carruseles de inicio','2025-05-10 17:19:51','2025-05-10 17:19:51'),(2,'Galería','Trabajos realizados para mostrar en galerías','2025-05-10 17:19:51','2025-05-10 17:19:51'),(3,'Antes/Después','Comparativas de antes y después de servicios','2025-05-10 17:19:51','2025-05-10 17:19:51'),(4,'Perfil','Fotos de perfil de empleados','2025-05-10 17:19:51','2025-05-10 17:19:51'),(5,'Servicios','Imágenes ilustrativas de servicios','2025-05-10 17:19:51','2025-05-10 17:19:51'),(6,'Productos','Imágenes de productos','2025-05-10 17:19:51','2025-05-10 17:19:51');
/*!40000 ALTER TABLE `tipos_multimedia` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-05-11  1:58:18
